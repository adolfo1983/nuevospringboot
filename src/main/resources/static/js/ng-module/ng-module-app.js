var app = angular.module('app', [ 'ngRoute', 'ngSanitize' ]); // Hace
																// referencia
// al "app" del
// index
...
app.config([ '$routeProvider', '$locationProvider',
		function($routeProvider, $locationProvider) {
			...
			$routeProvider.otherwise(// Carga la página si no encuentra la
										// URL
			// que se le indica
			{
				redirectTo : '/'
			...
			.when('/', // Carga la URL con el template y el controlador
			// asociado
			{
